  ...
  return {
    ...
    alternates: {
     ...
     openGraph: {
      ...
      images: [
        {
          url: `https://placehold.co/1200x630/1abc9c/ffffff?text=${encodeURI(service.title)}`,
          width: 1200,
          height: 630,
          alt: service.title,
        },
...
export default async function ServiceDetailPage({ params }: Props) {
  ...
  const whyPoints = [
    dict.features.items[0].title, // Honest Prices
    dict.features.items[1].title, // Easy Booking
    dict.features.items[2].title, // 24/7 Support
    dict.features.items[3].title, // Well-kept cars
  ]
    ...
    <div className="bg-secondary/20 dark:bg-background">
        ...
        <ScrollAnimationWrapper>
            <div className="relative h-[50vh] min-h-[350px] flex items-center justify-center text-white text-center">
                <Image
                    src={`https://placehold.co/1920x600/000000/ffffff?text=${encodeURI(service.title)}`}
